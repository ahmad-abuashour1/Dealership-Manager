...
export default function Inventory() {
  ...
  // We could pass filters to the API, but for a fast snappy UI with a moderate
  // number of cars, we fetch all and filter client-side, or use the API params.
  // Using API params as requested: params: { brand?, featured?, available? }
    ...
    <div className="w-full flex flex-col min-h-screen bg-muted/20">
      ...
      <div className="bg-card border-b border-border py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-8">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-foreground mb-4">Commercial Inventory</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">
            Browse our complete selection of premium commercial vehicles. Built for power, designed for your business.
          </p>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 pt-2 border-t border-border">
                <div className="flex items-center justify-between">
                  <Label htmlFor="available" className="cursor-pointer">In Stock Only</Label>
                  <Switch 
                    id="available" 
